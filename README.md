...
## 테스트 계획 및 결과
### 계획
1. 수집된 데이터의 질문과 답변 데이터를 바탕으로 질문을 했을때 파인 튜닝 모델이 유사한 답변을 하는지 확인
#### 데이터 내 답변으로 주로 추천 하는 분유를 추천함.
<img width="937" alt="image" src="./img//파인 튜닝 모델 답변 1.png" />
#### 유산균 관련된 답변 내용이 여러가지 있었는데 해당 내용들을 바탕으로 답변함
<img width="937" alt="image" src="./img//파인 튜닝 모델 답변 2.png" />

2. Vector DB 데이터를 바탕으로 응답 여부 확인
#### 벡터 디비 상의 전문적인 내용을 바탕으로 답변함
<img width="937" alt="image" src="./img/벡터 디비 답변.png" />
